...
public class OrderDetails extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        arr = donHangModel.getAllarr(maDh);
        request.setAttribute("Order", arr);
        System.out.println("Info:" +arr);
        System.out.println("SIZE:" +arr.size());
        
        billDTO info = donHangModel.getAll(maDh);
        request.setAttribute("OrderIn4", info);
        System.out.println("HAHA:" +maDh);
        RequestDispatcher rd = request.getRequestDispatcher("/frontEnd/OrderDetails.jsp");
